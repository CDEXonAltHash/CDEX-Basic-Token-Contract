...
contract HRC20 {
    ...
    string public name = 'Codex'; // Change it to your Token Name.
    string public symbol = 'CDEX'; // Change it to your Token Symbol. Max 4 letters!
    
    string public standard = 'Token 0.1'; // Do not change this one.

    uint8 public decimals = 8; // It's recommended to set decimals to 8.
    
    uint256 public totalSupply = 60000000000; // Change it to the Total Supply of your Token.
